...
# 1. --- Configuration ---
# IMPORTANT: Use the absolute path to your application directory
APP_DIR = '/home/encosnpm/prayerstats.encounteradelaide.com.au/prayer_dashboard/Prayer-Analysis'
